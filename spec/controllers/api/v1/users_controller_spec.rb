...
RSpec.describe Api::V1::UsersController, type: :controller do
  ...
  describe "GET #show" do
    ...
    it "should return the specified user with appropriate info" do
      sign_in tj
    ...
    it "should return the specified user's movies" do
    ...
    it "should return the specified user's movies with changed statuses" do
